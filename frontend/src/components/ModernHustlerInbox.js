  ...
  return (
    <div className="flex h-screen bg-black modern-inbox">
      ...
      <div className="w-80 bg-gray-950/80 backdrop-blur-sm border-r border-gray-800 flex flex-col chat-sidebar">
        {/* Header */}
        <div className="p-6 border-b border-gray-800 bg-gray-950/90">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className="pl-10 bg-gray-800/80 border-gray-700 text-white placeholder:text-gray-500 focus:border-gray-600 focus:ring-gray-600"
            />
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto chat-list-scroll">
          {(!Array.isArray(filteredThreads) || filteredThreads.length === 0) ? (
            <div className="flex flex-col items-center justify-center h-full text-gray-400">
              <MessageCircle className="h-12 w-12 mb-4 text-gray-500" />
            ...
            <div className="divide-y divide-gray-800/30">
              {filteredThreads.map(thread => (                  <div
                    ...
                    className={`p-4 cursor-pointer transition-colors duration-150 hover:bg-gray-800/50 chat-transition ${
                      selectedThread && selectedThread.taskId === thread.taskId && selectedThread.posterId === thread.posterId
                        ? 'bg-gray-800/50 border-r-2 border-gray-600'
                        : ''
                    }`}
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between mt-2">
                        ...
                        {thread.unreadCount > 0 && (
                          <Badge variant="default" className="bg-gray-700 text-white hover:bg-gray-600">
                            {thread.unreadCount}
                          </Badge>
                        )}
                      </div>
          ...
          <div className="flex-1 flex items-center justify-center bg-black">
            <div className="text-center">
              <div className="relative">
                ...
                <div className="absolute -top-1 -right-1 h-6 w-6 bg-gray-700 rounded-full flex items-center justify-center">
